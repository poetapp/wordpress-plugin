...
class Poet {
	 ...
	 *
	 * - Poet_Loader. Orchestrates the hooks of the plugin.
	 * - Poet_i18n. Defines internationalization functionality.
	 * - Poet_Admin. Defines all hooks for the admin area.
	 * - Poet_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'save_post', $plugin_admin, 'post_article' );
		$this->loader->add_filter( 'plugin_action_links_' . $this->plugin, $plugin_admin, 'add_settings_link' );
	 ...
	 *
	 * @return    Poet_Loader    Orchestrates the hooks of the plugin.
	 */
